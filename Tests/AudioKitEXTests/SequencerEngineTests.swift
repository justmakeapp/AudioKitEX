// Copyright AudioKit. All Rights Reserved. Revision History at http://github.com/AudioKit/AudioKit/
    ...
    class SequencerEngineTests: XCTestCase {
        ...
        func observerTest(sequence: NoteEventSequence,
                          frameCount: AUAudioFrameCount = 44_100,
            ...
            let block: AUScheduleMIDIEventBlock = { sampleTime, _, length, midiBytes in
                var bytes = [MIDIByte]()
            ...
            XCTAssertEqual(akSequencerEngineGetPosition(engine),
                           fmod(2.0 * Double(Int(frameCount) * renderCallCount) / 44_100, 4),
                           accuracy: 0.0001)
        ...
        func testBasicSequence() {
            ...
            XCTAssertEqual(events[0].timeStamp, 11_025)
            XCTAssertEqual(events[1].noteNumber!, 60)
            XCTAssertEqual(events[1].status!.type, .noteOff)
            XCTAssertEqual(events[1].timeStamp, 13_230)
        }
        ...
        func testChord() {
            ...
            XCTAssertEqual(events.map(\.timeStamp), [0, 0, 0, 22_050, 22_050, 22_050])
        }
        ...
        func testLoop() {
            ...
            let events = observerTest(sequence: seq, frameCount: 256, renderCallCount: Int(44_100 * 10 / 256))
            ...
            XCTAssertEqual(
                ...
                [0, 157, 34, 191, 136, 37, 170, 71, 16, 173, 50, 207, 152, 53, 186, 87, 32, 189, 66, 223]
            )
        }
        ...
        func testOverlap() {
            ...
            XCTAssertEqual(events.map(\.timeStamp), [0, 2_205, 4_410, 22_050])
        }
        ...
        func testSameNoteRepeating() {
            ...
            XCTAssertEqual(events.map(\.timeStamp), [0, 22_050, 22_050, 33_075])
        }
        ...
        func testSameNoteRepeatingInChords() {
            ...
            XCTAssertEqual(
                events.map(\.timeStamp),
                [0, 0, 0, 22_050, 22_050, 22_050, 22_050, 22_050, 22_050, 33_075, 33_075, 33_075]
            )
        }
        ...
        func testSameNoteRepeatingInChordsAcrossLoop() {
            ...
            XCTAssertEqual(events.map { $0.noteNumber! }, [60, 62, 64, 60, 62, 64,
                                                           ...
                                                           60, 62, 64, 60, 62, 64])
            XCTAssertEqual(
                events.compactMap { $0.status!.type },
                [.noteOn, .noteOn, .noteOn, .noteOff, .noteOff, .noteOff,
                 .noteOn, .noteOn, .noteOn, .noteOff, .noteOff,
                 .noteOff,
                 .noteOn, .noteOn, .noteOn, .noteOff, .noteOff,
                 .noteOff,
                 .noteOn, .noteOn, .noteOn, .noteOff, .noteOff,
            ...
            XCTAssertEqual(events.map(\.timeStamp), [0, 0, 0, 34, 34, 34,
                                                     34, 34, 34, 68, 68, 68,
        ...
        func testShortNotesAcrossLoop() {
            ...
            XCTAssertEqual(
                ...
                [.noteOn, .noteOn, .noteOn, .noteOff, .noteOff, .noteOff,
                 ...
                 .noteOff, .noteOff, .noteOff, .noteOn, .noteOn,
                 .noteOn,
                 .noteOn, .noteOn, .noteOn, .noteOff, .noteOff,
                 .noteOff,
            ...
            XCTAssertEqual(events.map(\.timeStamp), [0, 0, 0, 0, 0, 0,
                                                     43_658, 43_658, 43_658, 0, 0, 0,
                                                     0, 0, 0, 43_658, 43_658, 43_658,
                                                     0, 0, 0, 0, 0, 0,
                                                     43_658, 43_658, 43_658,
